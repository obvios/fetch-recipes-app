...
I believe the weakest part is the networking code. Ideally, I would implement a more robust networking infrastructure using protocols and generics to reduce boilerplate, support configurability, and with support for tracking metrics such as request/response times and error rates.
